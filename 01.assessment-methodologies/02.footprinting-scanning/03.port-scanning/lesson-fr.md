...
nmap -sS -p- <target_ip>        # scanner tous les 65535 ports
```
...
nmap -sU --top-ports 100 <target_ip>    # top 100 ports UDP
```
...
nmap -sS -sV --version-intensity 5 <target_ip>   # intensité maximale
```
